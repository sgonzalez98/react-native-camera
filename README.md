...
This is a fork of React Native Camera

In this library only changed the import of ViewPropTypes to work with React Native 0.70 and React 18
As it is a deprecated library, there will be no more updates.
